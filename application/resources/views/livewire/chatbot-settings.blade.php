<flux:tab.group>
    ...
    <flux:tab.panel name="embed">
        <div class="mt-4 space-y-4">
            <flux:field>
                ...
                <flux:input.group>
                    <flux:input readonly variant="filled" value='<iframe src="{{ url(' /chatbot/embed') }}" width="400"
                        height="600" style="border:0;position:fixed;bottom:20px;right:20px;z-index:1000;"></iframe>'
                        id="embedCode"
                        copyable
                        />
                </flux:input.group>
            ...
            <flux:field>
                <flux:label>Or use this JavaScript snippet for more control:</flux:label>
                <flux:input.group>
                    <flux:input readonly variant="filled" value='<script>
var iframe = document.createElement("iframe");
iframe.src = "{{ url(' /chatbot/embed') }}";
                        iframe.style.cssText="border:0;position:fixed;bottom:20px;right:20px;z-index:1000;width:400px;height:600px;"
